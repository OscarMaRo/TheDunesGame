...
public class PantallaAcercaDe extends Pantalla
{
    ...
    private void crearPantalla() {
        ...
        btnContenido = new Boton("Botones/botonContenido2.png", "Botones/botonContenidoPres.png");
        btnContenido.posicionarBoton(ANCHO/2 - btnContenido.getWidth()/2,ALTO/2-25);
        btnContenido.presionar(juego, 3);

        btnDesarrolladores = new Boton("Botones/botonDesarrolladores2.png", "Botones/botonDesarrolladoresPres.png");
        btnDesarrolladores.posicionarBoton(ANCHO/2 - btnContenido.getWidth()/2,ALTO/2-125);
        btnDesarrolladores.presionar(juego, 4);

        btnInstrucciones = new Boton("Botones/botonInstrucciones2.png", "Botones/botonInstruccionesPres.png");
