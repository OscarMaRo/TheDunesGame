...
public class PantallaInstrucciones extends Pantalla
{
    ...
    public void show() {
        ...
        texturaBotonDisparar = new Texture("Botones/move.jpeg");
    ...
    public void render(float delta) {
        ...
        batch.draw(texturaPadBack, 2*ANCHO/3+100 - texturaPadBack.getWidth()/2,2*ALTO/3 - texturaPadBack.getHeight()/2);
        batch.draw(texturaPadKnob, 2*ANCHO/3+100 - texturaPadKnob.getWidth()/2,2*ALTO/3 - texturaPadKnob.getHeight()/2);
        batch.draw(texturaBotonDisparar, 2*ANCHO+100 - texturaBotonDisparar.getWidth()/2, ALTO/3 - texturaBotonDisparar.getHeight()/2);
        ...
        instrucciones.render(batch, instJoystick,ANCHO/3+100,2*ALTO/3+50);
        String instDisparo = "Presiona el boton\nrojo para disparar";
        instrucciones.render(batch, instDisparo,ANCHO/3+100,ALTO/3+50);
        batch.end();
